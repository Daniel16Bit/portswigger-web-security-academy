...
Este exercício dispõe de uma funcionalidade de verificação de estoque que obtém dados de um sistema interno.

Para resolver o exercício, utilize a funcionalidade de verificação de estoque para procurar, no intervalo interno `192.168.0.X`, uma interface de administração na porta 8080 e, em seguida, utilize-a para eliminar o usuário carlos.
