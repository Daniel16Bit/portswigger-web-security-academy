...
A autenticação de dois fatores deste laboratório pode ser contornada. Você já obteve um nome de usuário e uma senha válidos, mas não tem acesso ao código de verificação 2FA do usuário. Para resolver o laboratório, acesse a página da conta do Carlos.
