...
Devemos descobrir e deletar o usuário CARLOS.

## Reconhecimento

Assim como informado pelo enunciado, este lab tem um painel administrativo sem proteção, mas com a URL aplicada de forma diferente. Com essa ideia, testei o `/robots.txt` para verificar se retornaria algo interessante, mas nada incomum. Pensando assim, precisei seguir por outro caminho, por isso foi usado o modo desenvolvedor.
